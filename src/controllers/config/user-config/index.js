...
const createUserConfig = async (params) => {
    ...
    let response = await configV1.UserConfig.create(params);
...
const updateUserConfig = async (params) => {
    ...
    const configV1 = await grpcClient.get('config', 'v1');
    let response = await configV1.UserConfig.update(params);
...
const deleteUserConfig = async (params) => {
    ...
    const configV1 = await grpcClient.get('config', 'v1');
    let response = await configV1.UserConfig.delete(params);
...
const getUserConfig = async (params) => {
    ...
    const configV1 = await grpcClient.get('config', 'v1');
    let response = await configV1.UserConfig.get(params);
...
const listUserConfigs = async (params) => {
    ...
    let response = await configV1.UserConfig.list(params);
...
const statUserConfigs = async (params) => {
    ...
    let response = await identityV1.UserConfig.stat(params);
